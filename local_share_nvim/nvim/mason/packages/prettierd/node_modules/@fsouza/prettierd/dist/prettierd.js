...
function getRuntimeDir() {
    var _a;
    const baseDir = (_a = process.env.XDG_RUNTIME_DIR) !== null && _a !== void 0 ? _a : os_1.default.homedir();
    const basename = path_1.default.basename(baseDir);
    return basename === "prettierd" || basename === ".prettierd"
        ? baseDir
        : path_1.default.join(baseDir, ".prettierd");
}
async function verifyRuntimeDir(dir) {
    try {
        await mkdir(dir, { recursive: true });
        await access(dir, fs_1.default.constants.W_OK);
    }
    catch (e) {
